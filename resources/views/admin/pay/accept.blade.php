...
<div class="m-2 card">
    <div class="card-body ">
        <div class="text-center row justify-content-md-center">
            ...
            <div dir="ltr" class="col-12">
                <p class="text-center display-5 w-100 text-success font-weight-bold">کارشناسان ما جهت پشتیبانی در خدمت
                    شما هستند</p>
            </div>
            <div dir="ltr" class="col-12">
            ...
            <div dir="ltr" class="col-12">
                <h4 class="text-center display-5 w-100 text-danger font-weight-bold">ساعت فروشی آقای صفری و دوستان غیر
                    از ابوالفضل</h4>
            </div>
